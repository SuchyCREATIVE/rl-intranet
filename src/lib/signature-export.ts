...
const WH = '#ffffff'   // Weiß für rechte Spalte (wie PDF-Vorlage)
...
function buildSignatureHTML(
  ...
  if (data.phone) contactRows.push(`
    <tr>
      <td style="font-family:${F};font-size:12px;color:${TG};padding-right:12px;padding-bottom:3px;white-space:nowrap;vertical-align:top;">Telefon</td>
  ...
  if (data.fax) contactRows.push(`
    <tr>
      <td style="font-family:${F};font-size:12px;color:${TG};padding-right:12px;padding-bottom:3px;white-space:nowrap;vertical-align:top;">Telefax</td>
      <td style="font-family:${F};font-size:12px;color:${TD};padding-bottom:3px;">${data.fax}</td>
    </tr>`)
  if (data.mobile) contactRows.push(`
    <tr>
      <td style="font-family:${F};font-size:12px;color:${TG};padding-right:12px;padding-bottom:3px;white-space:nowrap;vertical-align:top;">Mobil</td>
      <td style="font-family:${F};font-size:12px;color:${TD};padding-bottom:3px;">
  ...
  contactRows.push(`
    <tr>
      <td style="font-family:${F};font-size:12px;color:${TG};padding-right:12px;white-space:nowrap;vertical-align:top;">Mail</td>
  ...
  const standorteRow = data.showStandorte !== false
    ? `<tr>
        <td colspan="3" style="background-color:${DB};padding:8px 14px;border-top:2px solid ${Y};">
  ...
  <tbody>
    <tr>
      ...
      <td bgcolor="${LB}" valign="top"
        ...
        <table cellpadding="0" cellspacing="0" border="0" style="margin-top:12px;">
          <tbody>
            ...
            <tr><td style="font-family:${F};font-size:12px;color:${TG};padding-bottom:2px;">${company.address}</td></tr>
            <tr><td style="font-family:${F};font-size:12px;color:${TG};">${company.city}</td></tr>
          </tbody>
        </table>
      ...
      <td width="120" bgcolor="${WH}" valign="top" align="center"
          style="width:120px;background-color:${WH};vertical-align:top;text-align:center;padding:18px 14px;">
        <img src="${logoSrc}" width="92" height="auto" alt="${company.legalName}"
          style="display:block;width:92px;height:auto;margin:0 auto;" />
      </td>
